...
expected_install="install_dirs install_eula install_bds ldd_check install_world install_behaviorpacks activate_behaviorpacks install_resourcepacks activate_resourcepacks apply_server_properties"
